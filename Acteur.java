...
/* public class ActeurNoeud extends AbstarctActor{
	...
	private ActeurNoeud(int id, ActorRef v){
	...
	public static Props props(int n, ActorRef v){
		props.create(ActeurNoeud.class, n, v);
	}
   ...
   public class Anneau extends AbstarctActor{
	...
	private Anneau(int nb){
		...
		for(int i=0; i<id.size(); i++){
			 ActorRef noeud = getContext().actorOf(ActeurNoeud.props(id.get(i), /*mettre le voisin droite avec vérif du dernier));
